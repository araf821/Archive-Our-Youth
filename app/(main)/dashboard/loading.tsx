...
const loading: FC<loadingProps> = ({}) => {
  return (
    <div className="mx-auto mt-8 flex max-w-screen-md flex-col gap-2 px-4">
      ...
      <div className="relative flex justify-between rounded-md border border-border-dark p-2">
        ...
        <Skeleton className="absolute right-2 top-2 size-4 md:h-8 md:w-8" />
      </div>
      <div className="mt-8 flex flex-col gap-4">
        ...
        {/* Posts */}
        <div className="flex w-full gap-2 rounded-sm border border-border-dark p-2 max-md:flex-col">
          <Skeleton className="aspect-square w-full md:max-w-[300px]" />
          <hr className="border-border-dark md:hidden" />
