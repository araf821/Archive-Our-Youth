...
const DashboardSidebar: FC<DashboardSidebarProps> = ({ currentUser }) => {
  return (
    <div className="morph-md flex h-fit gap-4 rounded-md border-2 border-zinc-700 p-2 transition duration-300 hover:scale-[1.02] hover:border-green-500 hover:shadow-2xl hover:shadow-green-700/30 max-[450px]:flex-col lg:sticky lg:top-8 lg:flex-col">
